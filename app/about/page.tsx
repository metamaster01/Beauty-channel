    ...
    <section className="relative w-full min-h-screen bg-[#0B0B0B] text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-14 pt-36 pb-32">
        ...
        <div className="mt-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <p>
              At Neelu Beauty, we believe beauty is not about perfection — it’s about
              feeling confident in your own skin. Our goal is to enhance your natural
              beauty while giving you a relaxing, luxurious experience every time you visit.
            </p>

            <p>
              With a passion for creativity and precision, Neelu Beauty offers personalized
              beauty services designed to suit your unique style, skin type, and preferences.
              Whether it’s a simple self-care session or a complete makeover, we make sure you
              leave feeling refreshed, confident, and beautiful.
            </p>
          </motion.div>
        </div>
        ...
        <div className="mt-28 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <p>
              Neelu Beauty was founded with a simple vision — to create a space where
              clients feel cared for, understood, and truly valued. What started as
              a passion for beauty has grown into a trusted destination for high-quality
              salon services, modern techniques, and professional care.
            </p>

            <p>
              We combine expert skills, premium products, and a client-first approach
              to deliver results you’ll love — every single time.
            </p>
          </motion.div>
        </div>
