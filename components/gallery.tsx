  ...
  return (
    <section className="relative w-full bg-white">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {/* floating blobs */}
        <div className="absolute -top-40 left-1/2 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-neutral-200/55 blur-3xl animate-[float1_9s_ease-in-out_infinite]" />
        <div className="absolute -bottom-48 right-[-80px] h-[640px] w-[640px] rounded-full bg-neutral-200/45 blur-3xl animate-[float2_11s_ease-in-out_infinite]" />
        <div className="absolute top-32 left-[-90px] h-[420px] w-[420px] rounded-full bg-neutral-100 blur-3xl animate-[float3_13s_ease-in-out_infinite]" />

        {/* soft grid */}
        <div className="absolute inset-0 opacity-[0.20] [background:radial-gradient(circle_at_1px_1px,rgba(0,0,0,0.10)_1px,transparent_0)] [background-size:22px_22px]" />

        {/* subtle vignette */}
        <div className="absolute inset-0 [box-shadow:inset_0_0_140px_rgba(0,0,0,0.10)]" />
      </div>

      <div ref={containerRef} className="relative mx-auto w-full max-w-6xl px-4 sm:px-6 py-10 sm:py-12">
        {/* Header (unchanged) */}
        <div
          className={[
        ...
        <div className="mt-10 hidden md:grid grid-cols-12 gap-6">
          ...
          >
            <div
              ...
              className="group relative overflow-hidden rounded-2xl bg-neutral-100 shadow-sm ring-1 ring-black/5"
            ...
            >
              ...
              <div className="pointer-events-none absolute inset-0 rounded-2xl opacity-0 transition duration-500 group-hover:opacity-100">
                <div className="absolute inset-[-2px] rounded-2xl bg-[conic-gradient(from_90deg,rgba(0,0,0,0.0),rgba(0,0,0,0.16),rgba(0,0,0,0.0))] blur-sm animate-[spin_2.8s_linear_infinite]" />
              </div>

              {/* hover glow bloom */}
              <div className="pointer-events-none absolute -inset-12 opacity-0 blur-3xl transition duration-700 group-hover:opacity-100 [background:radial-gradient(circle_at_30%_30%,rgba(0,0,0,0.12),transparent_60%)]" />
              ...
              >
                ...
                <div className="pointer-events-none absolute inset-0">
                  {/* gradient depth */}
                  <div className="absolute inset-0 bg-gradient-to-tr from-black/28 via-black/0 to-black/0 opacity-75" />
                  {/* shimmer sweep */}
                  ...
                  {/* vignette */}
                  <div className="absolute inset-0 [box-shadow:inset_0_0_120px_rgba(0,0,0,0.20)]" />
                </div>
              </div>
            </div>
          </div>

          {/* See All card (same layout, only effects) */}
          <div
            className={[
          ...
          >
            {hrefSeeAll ? (
              ...
              <button
                type="button"
                onClick={onSeeAll}
                className="group relative flex h-full w-full items-center justify-center rounded-2xl bg-neutral-100 shadow-sm ring-1 ring-black/5 transition hover:bg-neutral-200/70 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900"
                aria-label="See all gallery items"
              >
                <span className="text-lg font-medium text-neutral-900 transition group-hover:tracking-wide">
                  See All
                </span>

                <span className="pointer-events-none absolute -inset-8 rounded-3xl opacity-0 blur-3xl transition duration-700 group-hover:opacity-100 [background:radial-gradient(circle_at_50%_50%,rgba(0,0,0,0.14),transparent_60%)]" />
                <span className="pointer-events-none absolute inset-0 rounded-2xl opacity-0 transition duration-500 group-hover:opacity-100 [background:linear-gradient(90deg,transparent,rgba(0,0,0,0.10),transparent)] [background-size:200%_100%] animate-[sweep_1.7s_linear_infinite]" />
              </button>
            )}
          </div>

          {/* Bottom row (bigger height + tilt + glow + shimmer) */}
          {bottom.map((item, idx) => {
            ...
            return (
              ...
              >
                <div
                  ...
                  className="group relative overflow-hidden rounded-2xl bg-neutral-100 shadow-sm ring-1 ring-black/5 transition-transform duration-500 hover:-translate-y-1"
                  style={{ transformStyle: "preserve-3d" }}
                >
                  {/* glow border */}
                  <div className="pointer-events-none absolute inset-0 rounded-2xl opacity-0 transition duration-500 group-hover:opacity-100">
                    <div className="absolute inset-[-2px] rounded-2xl bg-[conic-gradient(from_120deg,rgba(0,0,0,0.0),rgba(0,0,0,0.14),rgba(0,0,0,0.0))] blur-sm animate-[spin_3.2s_linear_infinite]" />
                  </div>

                  {/* bloom */}
                  <div className="pointer-events-none absolute -inset-12 opacity-0 blur-3xl transition duration-700 group-hover:opacity-100 [background:radial-gradient(circle_at_40%_25%,rgba(0,0,0,0.14),transparent_60%)]" />
                  ...
                  >
                    ...
                    <div className="pointer-events-none absolute inset-0">
                      ...
                      <div className="absolute inset-0 opacity-0 transition duration-500 group-hover:opacity-100">
                        ...
                        <div className="absolute inset-0 [box-shadow:inset_0_0_90px_rgba(0,0,0,0.18)]" />
                      </div>
        ...
        {/* Mobile (same structure; effects only) */}
        <div
          className={[
        ...
        >
          <div className="mb-4 flex items-center justify-end">
            {hrefSeeAll ? (
              <Link
                href={hrefSeeAll}
                className="rounded-full bg-neutral-900 px-4 py-2 text-xs font-semibold text-white shadow-sm active:scale-[0.98]"
              >
                See All
              </Link>
            ) : (
            ...
            <div className="flex gap-4 overflow-x-auto pb-2 pr-2 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden snap-x snap-mandatory">
              {items.map((item) => (
                <div key={item.id} className="snap-start min-w-[85%] sm:min-w-[70%]">
                  <div className="group relative overflow-hidden rounded-2xl bg-neutral-100 shadow-sm ring-1 ring-black/5">
                    <div className="relative h-[340px] w-full">
                      ...
                      <div className="pointer-events-none absolute inset-0 opacity-[0.05] [background-image:url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%22200%22 height=%22200%22><filter id=%22n%22><feTurbulence type=%22fractalNoise%22 baseFrequency=%221.0%22 numOctaves=%222%22 stitchTiles=%22stitch%22/></filter><rect width=%22200%22 height=%22200%22 filter=%22url(%23n)%22 opacity=%220.32%22/></svg>')]" />
                    </div>

                    <div className="pointer-events-none absolute -inset-10 opacity-0 blur-3xl transition duration-700 group-active:opacity-100 [background:radial-gradient(circle_at_50%_30%,rgba(0,0,0,0.14),transparent_60%)]" />
                  </div>
                </div>
              ))}
            </div>
